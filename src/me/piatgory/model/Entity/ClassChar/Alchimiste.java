    ...
    public void learnSpell(int level){
        switch (level){
            case 2:
                ...
                break;
            case 5:
                this.getCapacities().add(new Capacity("Mixture affaiblissante","Attaque qui affaibli l'ennemi ",new Effect(new Buff("Affaibli 2", StatsBuilder.make(0,0,-4),10),-10),1,true));
                break;
            case 10:
